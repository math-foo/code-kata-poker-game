...
class testScoredPokerHandSetScore(unittest.TestCase):
	def setUp(self):
		base = cardListCreator([(3,2),(0,14),(0,5),(1,4),(2,8),(2,9),(3,7)])
		self.hand = poker_hand.ScoredPokerHand(base)

	def test_initScoreClassNegative(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, -1)

	def test_initScoreClassHigh(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 10)

	def test_initValueNegative(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, value=-2)

	def test_initValueOne(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, value=1)

	def test_initValueHigh(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, value=20)

	def test_initSecondaryValueNegative(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, secondary_value=-2)

	def test_initSecondaryValueOne(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, secondary_value=1)

	def test_initSecondaryValueHigh(self):
		self.assertRaises(poker_hand.ScoredPokerHandInitializationRangeError, self.hand._set_score, 0, secondary_value=20)

	def test_initTooManySideCards(self):
		side_cards = cardListCreator([(0,2),(0,3),(1,4),(1,5),(2,6),(2,7)])
		self.assertRaises(poker_hand.ScoredPokerHandInitializationSideCardError, self.hand._set_score, 0, side_cards=side_cards)
...
class testScoredPokerHandInit(unittest.TestCase):
	...
	def test_initSuccessful(self):
		...
		self.assertEquals(scored_poker_hand.score_class, 0)
		self.assertEquals(scored_poker_hand.value, 14)
...
class testScoredPokerHand(unittest.TestCase):
	def test_RoyalFlush(self):
		...
		self.assertEquals(9, royal_flush_hand.score_class)
	...
	def test_StraightFlush(self):
		...
		self.assertEquals(8, straight_flush_hand.score_class)
		self.assertEquals(13, straight_flush_hand.value)
	...
	def test_StraightFlushAceLow(self):
		...
		self.assertEquals(8, straight_hand.score_class)
		self.assertEquals(5, straight_hand.value)
	...
	def test_FourOfAKind(self):
		...
		self.assertEquals(7, four_hand.score_class)
		self.assertEquals(11, four_hand.value)
		self.assertEquals(expected_side_cards, four_hand.side_cards)
	...
	def test_FullHouse(self):
		...
		self.assertEquals(6, full_house_hand.score_class)
		self.assertEquals(7, full_house_hand.value)
		self.assertEquals(2, full_house_hand.secondary_value)
	...
	def test_Flush(self):
		...
		self.assertEquals(5, flush_hand.score_class)
		self.assertEquals(11, flush_hand.value)
		self.assertEquals(expected_side_cards, flush_hand.side_cards)
	...
	def test_Straight(self):
		...
		self.assertEquals(4, straight_hand.score_class)
		self.assertEquals(10, straight_hand.value)
	...
	def test_ThreeOfAKindHighSide(self):
		...
		self.assertEquals(3, three_hand.score_class)
		self.assertEquals(2, three_hand.value)
		self.assertEquals(expected_side_cards, three_hand.side_cards)
	...
	def test_ThreeOfAKindLowSide(self):
		...
		self.assertEquals(3, three_hand.score_class)
		self.assertEquals(13, three_hand.value)
		self.assertEquals(expected_side_cards, three_hand.side_cards)
	...
	def test_ThreeOfAKindMixedSide(self):
		...
		self.assertEquals(3, three_hand.score_class)
		self.assertEquals(11, three_hand.value)
		self.assertEquals(expected_side_cards, three_hand.side_cards)
	...
	def test_TwoPairHighKicker(self):
		...
		self.assertEquals(2, two_pair_hand.score_class)
		self.assertEquals(7, two_pair_hand.value)
		self.assertEquals(5, two_pair_hand.secondary_value)
		self.assertEquals(expected_side_cards, two_pair_hand.side_cards)
	...
	def test_TwoPairLowKicker(self):
		...
		self.assertEquals(2, two_pair_hand.score_class)
		self.assertEquals(12, two_pair_hand.value)
		self.assertEquals(10, two_pair_hand.secondary_value)
		self.assertEquals(expected_side_cards, two_pair_hand.side_cards)
	...
	def test_Pair(self):
		...
		self.assertEquals(1, pair_hand.score_class)
		self.assertEquals(8, pair_hand.value)
		self.assertEquals(expected_side_cards, pair_hand.side_cards)
	...
	def test_HighCard(self):
		...
		self.assertEquals(0, ace_high_hand.score_class)
		self.assertEquals(14, ace_high_hand.value)
		self.assertEquals(expected_side_cards, ace_high_hand.side_cards)
